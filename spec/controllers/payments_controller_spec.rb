...
describe PaymentsController do
  ...
  let(:valid_attributes) { { trade_id: trade.id, amount: 10 } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved payment as @payment" do
        ...
        post :create, {:payment => { "trade_id" => "invalid value" }}, valid_session
        assigns(:payment).should be_a_new(Payment)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested payment" do
        ...
        Payment.any_instance.should_receive(:update).with({ "trade_id" => "" })
        put :update, {:id => payment.to_param, :payment => { "trade_id" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the payment as @payment" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Payment.any_instance.stub(:save).and_return(false)
        put :update, {:id => payment.to_param, :payment => { "trade_id" => "invalid value" }}, valid_session
        assigns(:payment).should eq(payment)
      end
