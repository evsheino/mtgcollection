  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved loan as @loan" do
        ...
        post :create, {:loan => { "owner_id" => "invalid value" }}, valid_session
        assigns(:loan).should be_a_new(Loan)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested loan" do
        ...
        Loan.any_instance.should_receive(:update).with({ "owner_id" => "1" })
        put :update, {:id => loan.to_param, :loan => { "owner_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the loan as @loan" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Loan.any_instance.stub(:save).and_return(false)
        put :update, {:id => loan.to_param, :loan => { "owner_id" => "invalid value" }}, valid_session
        assigns(:loan).should eq(loan)
      end
