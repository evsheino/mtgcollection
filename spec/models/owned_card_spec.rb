...
describe OwnedCard do
  ...
  describe ".add_or_update_from_mtg_db_card" do
    ...
    it "returns an OwnedCard" do
      oc = OwnedCard.add_or_update_from_mtg_db_card(mtg_db_card, user.id, 1, false)
    ...
    it "increments the number if the card is in the user's collection" do
      OwnedCard.add_or_update_from_mtg_db_card(mtg_db_card, user.id, 1, false)
      oc = OwnedCard.add_or_update_from_mtg_db_card(mtg_db_card, user.id, 2, false)
