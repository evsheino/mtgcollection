...
describe Card do
  it "is not valid without a name" do
    card = Card.create(expansions: [FactoryGirl.create(:expansion)])

    expect(card).not_to be_valid
  end

  it "is valid with a name and expansion" do
    card = Card.create(name: 'Card',expansions: [FactoryGirl.create(:expansion)])
